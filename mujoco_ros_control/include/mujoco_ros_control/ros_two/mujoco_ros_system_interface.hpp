...
class MujocoRosSystemInterface : public hardware_interface::SystemInterface
{
public:
	...
	virtual bool initSim(rclcpp_lifecycle::LifecycleNode::SharedPtr &model_nh,
...
#endif // MUJOCO_ROS_CONTROL__ROS_TWO__MUJOCO_ROS_SYSTEM_INTERFACE_HPP_
