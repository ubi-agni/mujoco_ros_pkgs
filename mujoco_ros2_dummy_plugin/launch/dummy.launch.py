...
def generate_launch_description():
    ...
    mujoco_ros2_control_path = get_package_share_directory('mujoco_ros2_control')
    ...
    return LaunchDescription([
        IncludeLaunchDescription(
            ...
            FrontendLaunchDescriptionSource(
                mujoco_ros2_control_path + '/launch/launch_server.launch'
            ),
            launch_arguments={
                'use_sim_time': 'true',
                'modelfile': xml_path,
        ...
        Node(  # RVIZ dependency; broken right now
            ...
            executable='spawner',
            arguments=['joint_state_broadcaster', '-c', concatenate_ns(
                ns,
                'controller_manager',
                True
            )],
