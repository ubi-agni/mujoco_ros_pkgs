...
# Assigns the compile options to the variable OUTPUT_VAR
function(get_avx_compile_options OUTPUT_VAR)
    ...
    if(CAN_BUILD_AVX)
        message(VERBOSE "Checking if AVX is available... yes")
        set("${OUTPUT_VAR}" ${CMAKE_REQUIRED_FLAGS} PARENT_SCOPE)
    else()
        message(VERBOSE "Checking if AVX is available... no")
